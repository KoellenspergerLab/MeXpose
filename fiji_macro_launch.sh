...
# Arguments are the image directory path, "r='the desired pixel radius'"
# and "t='the desired intensity difference threshold'"
fiji-outliers() {
    if [ "$#" -ne 3 ]; then
        echo "Usage: fiji-outliers /path/to/images 'r=radius' 't=threshold'"
        return 1
    fi
    home/Fiji.app/ImageJ-linux64 --headless --run /home/mexpose/macros/outlier_macro.py "inputDir='$1', radius=$2, threshold=$3"
}
